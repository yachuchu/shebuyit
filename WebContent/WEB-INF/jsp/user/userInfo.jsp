...
$(document).ready(function(){
	...
	var validator = $("#userform").validate({
		...
		submitHandler: function() {
						dojo.io.iframe.send({
			        		url: "<c:url value='/user/saveInfo.do'/>",  
...
<!-- Header -->
	...
	<div id="pagetitle">
		<div class="wrapper">
			<h1><fmt:message key="navigation.userInfo" /></h1>
			<!-- Quick search box -->
	...
	<div id="page">
		...
		<div class="wrapper">
				...
				<section class="column width6 first">					
					...
					<form id="userform" method="post" action="<c:url value='/user/saveInfo.do'/>">	
					        <p>
					        <label><fmt:message key='user.userId'/><fmt:message key='common.colon'/></label>${userInfo.id}
						    <input type="hidden" id="userId" class="" value="${userInfo.id}" name="userId"/>				    
						    </p>
						    
							<p>
							  <label><fmt:message key='user.username'/><fmt:message key='common.colon'/></label> ${userInfo.userName}
							 
							</p>	
							
							<p>
							  <label><fmt:message key='user.type'/><fmt:message key='common.colon'/></label> ${userInfo.type}						      	
